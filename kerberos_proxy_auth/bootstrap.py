...
def _register_bootstrap_functions():
    ...
    # ourselves just in case it is somehow called a second time.
    ...
    # TODO: eventually add wrapt_urllib3, wrapt_botocore
...
def bootstrap():
    ...
    # initialized properly. What is the last thing executed depends on
    # whether 'usercustomize' module support is enabled. Such support
    # will not be enabled in Python virtual environments. We therefore
